 ...
 * 
 * This file is part of mixare and is used into Smart AR app.
 * 
...
import gr.telesto.mgr.datasource.DataSourceManager;
import gr.telesto.mgr.datasource.DataSourceManagerFactory;
import gr.telesto.mgr.downloader.DownloadManager;
import gr.telesto.mgr.downloader.DownloadManagerFactory;
import gr.telesto.mgr.location.LocationFinder;
import gr.telesto.mgr.location.LocationFinderFactory;
import gr.telesto.mgr.webcontent.WebContentManager;
import gr.telesto.mgr.webcontent.WebContentManagerFactory;
...
public class MixContext extends ContextWrapper implements MixContextInterface {
	...
	public void loadMixViewWebPage(String url) throws Exception {
		...
		Log.v("Browser", "connecting to " + url);	
