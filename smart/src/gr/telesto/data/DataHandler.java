...
public class DataHandler {
	...
	private List<LocalMarker> markerList = new ArrayList<LocalMarker>();
	
	public void addMarkers(List<LocalMarker> markers) {

//		Log.v(MixView.TAG, "Marker before: "+markerList.size());
		for(LocalMarker ma:markers) {
...
//		Log.d(MixView.TAG, "Marker count: "+markerList.size());
	...
	public void updateActivationStatus(MixContext mixContext) {
		...
		for(LocalMarker ma: markerList) {
			...
			Class<? extends LocalMarker> mClass=ma.getClass();
...
//	 */
	public List<LocalMarker> getMarkerList() {
		return markerList;
	}
	 ...
	 * @deprecated Nobody should get direct access to the list
	 */
	public void setMarkerList(List<LocalMarker> markerList) {
	...
	public LocalMarker getMarker(int index) {
