 ...
 */
package gr.telesto.mgr.downloader;
...
public class DownloadResult {
	...
	public DownloadResult() {
		...
		this.params = "";
		this.markers = new ArrayList<LocalMarker>();
		this.error = true;
	...
	public List<LocalMarker> getMarkers() {
		return markers;
	}

	public void setMarkers(List<LocalMarker> markers) {
	...
	public void setAccomplish(String idOfDownloadRequest, List<LocalMarker> markers, DataSource ds ) {
